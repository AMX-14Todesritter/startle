...
*Startle* is a set of methods for lineage tree reconstruction by inffering
the most parsimonious tree under the *star homoplasy* evolutionary model. 
If you find the tool useful in your research, please cite us at:
